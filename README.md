...
Once you have the file in place in the root of your folder, create a folder and named images ``` images/ ``` and dump all images that you want to upload in it. And finally just run grunt ``` grunt aws_s3```. That should take few seconds or minutes depending how many files are in the images folder.
